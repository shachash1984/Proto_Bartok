...
public class Utils : MonoBehaviour
{
    ...
    static public Quaternion Lerp(Quaternion qFrom, Quaternion qTo, float u)
    {
        Vector3 res = (1 - u) * qFrom.eulerAngles + u * qTo.eulerAngles;
        return (Quaternion.Euler(res));
    }
    ...
    static public Quaternion Bezier(float u, List<Quaternion> qList)
    {
        ...
        // The result is the Lerp of these two shorter Lists
        Quaternion res = Lerp(Bezier(u, qListL), Bezier(u, qListR), u);
        return (res);
    }
